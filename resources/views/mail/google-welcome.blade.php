...
<body>
    <div style="max-width:580px; margin:0 auto; background:#100e25; border-radius:20px; overflow:hidden; border:1px solid #2a2754; box-shadow:0 24px 64px rgba(0,0,0,0.6);">
        ...
        <div style="background:linear-gradient(135deg, #0f0c2e 0%, #1e1047 50%, #3b1264 100%); padding:48px 40px 40px; text-align:center;">
            ...
            <h1 style="color:#ffffff; font-size:28px; font-weight:700; margin:0 0 10px; line-height:1.3;">{{ $t['welcome'] }}{{ $name }}!</h1>
            <p style="color:#b8aff5; font-size:15px; margin:0; line-height:1.6;">{!! nl2br(e($t['subtitle'])) !!}</p>
        </div>

        <div style="padding:36px 40px;">

            <p style="font-size:10px; font-weight:700; color:#4e4a80; letter-spacing:1.5px; text-transform:uppercase; margin:0 0 12px;">{{ $t['your_account'] }}</p>
            <div style="background:#1a1735; border:1px solid #2d2956; border-radius:14px; overflow:hidden; margin-bottom:24px;">
                <div style="display:flex; align-items:center; gap:14px; padding:16px 20px; border-bottom:1px solid #2d2956;">
                    ...
                    <div>
                        <p style="color:#5a5690; font-size:10px; font-weight:600; text-transform:uppercase; letter-spacing:1px; margin:0 0 3px;">{{ $t['email_label'] }}</p>
                ...
                <div style="display:flex; align-items:center; gap:14px; padding:16px 20px;">
                    ...
                    <div>
                        <p style="color:#5a5690; font-size:10px; font-weight:600; text-transform:uppercase; letter-spacing:1px; margin:0 0 3px;">{{ $t['sign_in_method'] }}</p>
            ...
            <div style="background:#1a1735; border:1px solid #2d2956; border-radius:12px; padding:16px 20px; margin-bottom:28px;">
                <p style="color:#9490cc; font-size:14px; margin:0; line-height:1.6;">ℹ️ &nbsp;{{ $t['sign_in_info'] }}</p>
            </div>
