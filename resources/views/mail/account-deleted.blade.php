...
<body style="margin:0; padding:30px 16px; background:linear-gradient(135deg, #080714 0%, #130d2e 100%); min-height:100vh;">
    <div style="max-width:580px; margin:0 auto; background:#100e25; border-radius:20px; overflow:hidden; border:1px solid #2a2754; box-shadow:0 24px 64px rgba(0,0,0,0.6);">
        ...
        <div style="background:linear-gradient(135deg, #0f0c2e 0%, #1e1047 50%, #3b1264 100%); padding:48px 40px 40px; text-align:center;">
            ...
            <p style="color:#b8aff5; font-size:15px; margin:0; line-height:1.6;">Your {{ config('app.name') }} account has been permanently deleted.</p>
        </div>
        ...
        <div style="padding:36px 40px;">
            ...
            <div style="margin-bottom:24px;">
                <p style="font-size:10px; font-weight:700; color:#4e4a80; letter-spacing:1.5px; text-transform:uppercase; margin:0 0 12px;">Deleted Account</p>
            <div style="background:#1a1735; border:1px solid #2d2956; border-radius:14px; display:flex; align-items:center; gap:14px; padding:18px 20px; margin-bottom:24px;">
                ...
                <div>
                    <p style="color:#5a5690; font-size:10px; font-weight:600; text-transform:uppercase; letter-spacing:1px; margin:0 0 3px;">Account Email</p>
            ...
            {{-- What happened --}}
            <div style="margin-bottom:24px;">
                <p style="font-size:10px; font-weight:700; color:#4e4a80; letter-spacing:1.5px; text-transform:uppercase; margin:0 0 12px;">What This Means</p>
            <div style="background:#1a1735; border:1px solid #2d2956; border-radius:14px; padding:18px 20px; margin-bottom:24px;">
                <div style="display:flex; gap:12px; margin-bottom:14px;">
                    ...
                    <p style="color:#9490cc; font-size:14px; margin:0; line-height:1.6;">All your personal data has been permanently removed from our systems.</p>
                </div>
                <div style="display:flex; gap:12px;">
                    <span style="font-size:16px; flex-shrink:0;">🔒</span>
                    <p style="color:#9490cc; font-size:14px; margin:0; line-height:1.6;">You will no longer be able to log in with this account.</p>
                </div>
            </div>
            </div>
            ...
            <div style="background:#1c0a0a; border:1px solid #7f1d1d; border-radius:12px; padding:16px 20px; margin-bottom:28px;">
                <p style="color:#fca5a5; font-size:13px; margin:0; line-height:1.6;">⚠️ &nbsp;<strong>Didn't request this?</strong> If you believe this deletion was a mistake, please contact our support team immediately.</p>
            </div>
            ...
            <div style="background:#130d2e; border:1px solid rgba(196,181,253,0.18); border-radius:14px; padding:22px 24px; text-align:center;">
                <p style="color:#c4b5fd; font-size:14px; font-weight:500; margin:0 0 5px;">Thank you for being part of {{ config('app.name') }}.</p>
                <p style="color:#7c6fad; font-size:13px; margin:0;">We hope to see you again someday. Take care! 💜</p>
            </div>
        </div>
