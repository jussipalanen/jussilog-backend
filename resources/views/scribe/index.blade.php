                ...
                <li class="tocify-item level-1" data-unique="ai-agent">
                    <a href="#ai-agent">AI Agent</a>
                                    ...
                                    <ul id="tocify-subheader-ai-agent" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="ai-agent-GETapi-agent-resume-suggestions">
                                <a href="#ai-agent-GETapi-agent-resume-suggestions">Get a list of suggested questions for the AI agent.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-PATCHapi-users-update-role">Update a user's role by identifier (id, username or email).</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-agent-resume-ask">
                                <a href="#endpoints-POSTapi-agent-resume-ask">POST api/agent/resume/ask</a>
                            </li>
...
<p>Authenticate with a Sanctum bearer token via the Authorization header, for example: <code>Authorization: Bearer {token}</code>.</p>
        ...
        <h1 id="ai-agent">AI Agent</h1>
                                ...
                                <h2 id="ai-agent-GETapi-agent-resume-suggestions">Get a list of suggested questions for the AI agent.</h2>
...
<span id="example-requests-GETapi-agent-resume-suggestions">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://backend-laravel.dev.jussialanen.com/api/agent/resume/suggestions" \
...
<div class="javascript-example">
    ...
    "https://backend-laravel.dev.jussialanen.com/api/agent/resume/suggestions"
);
...
<span id="example-responses-GETapi-agent-resume-suggestions">
            <blockquote>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;suggestions&quot;: [
        {
            &quot;en&quot;: &quot;Who is Jussi Alanen?&quot;,
            &quot;fi&quot;: &quot;Kuka on Jussi Alanen?&quot;
        },
        {
            &quot;en&quot;: &quot;What are the main skills on this resume?&quot;,
            &quot;fi&quot;: &quot;Mitk&auml; ovat t&auml;rkeimm&auml;t taidot?&quot;
        },
        {
            &quot;en&quot;: &quot;What work experience does Jussi have?&quot;,
            &quot;fi&quot;: &quot;Millainen ty&ouml;kokemus Jussilla on?&quot;
        },
        {
            &quot;en&quot;: &quot;What is the educational background?&quot;,
            &quot;fi&quot;: &quot;Mik&auml; on koulutustausta?&quot;
        },
        {
            &quot;en&quot;: &quot;What projects has Jussi worked on?&quot;,
            &quot;fi&quot;: &quot;Miss&auml; projekteissa Jussi on ollut mukana?&quot;
        },
        {
            &quot;en&quot;: &quot;What certifications does Jussi have?&quot;,
            &quot;fi&quot;: &quot;Mit&auml; sertifikaatteja Jussilla on?&quot;
        },
        {
            &quot;en&quot;: &quot;Where can I find the LinkedIn profile?&quot;,
            &quot;fi&quot;: &quot;Mist&auml; l&ouml;yd&auml;n LinkedIn-profiilin?&quot;
        },
        {
            &quot;en&quot;: &quot;What languages does Jussi speak?&quot;,
            &quot;fi&quot;: &quot;Mit&auml; kieli&auml; Jussi osaa?&quot;
        },
        {
            &quot;en&quot;: &quot;Tell about your resume/CV?&quot;,
            &quot;fi&quot;: &quot;Kerro ansioluettelostasi?&quot;
        }
    ]
}</code>
 </pre>
    </span>
<span id="execution-results-GETapi-agent-resume-suggestions" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-agent-resume-suggestions"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-agent-resume-suggestions"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-agent-resume-suggestions" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-agent-resume-suggestions">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-agent-resume-suggestions" data-method="GET"
      data-path="api/agent/resume/suggestions"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-agent-resume-suggestions', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-agent-resume-suggestions"
                    onclick="tryItOut('GETapi-agent-resume-suggestions');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-agent-resume-suggestions"
                    onclick="cancelTryOut('GETapi-agent-resume-suggestions');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-agent-resume-suggestions"
            ...
            <b><code>api/agent/resume/suggestions</code></b>
        </p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-agent-resume-suggestions"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-agent-resume-suggestions"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://backend-laravel.dev.jussialanen.com/api/blogs/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://backend-laravel.dev.jussialanen.com/api/blogs/17"
);
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a file. Must be an image. Must not be greater than 5120 kilobytes. Example: <code>/tmp/phpDNeCAI</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a file. Must be an image. Must not be greater than 5120 kilobytes. Example: <code>/tmp/phpoComaI</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>tags</code></b>&nbsp;&nbsp;
<small>string[]</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "https://backend-laravel.dev.jussialanen.com/api/blog-categories/17" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
</code></pre></div>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the blog category. Example: <code>17</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="2026-03-30T08:05:01"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-03-30T08:05:01</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>notes</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    ...
    --form "quantity=50"\
    --form "visibility=1"\
    --form "featured_image=@/tmp/phpcNfbCb" \
    --form "images[]=@/tmp/phpfFhKCb" \
    --form "images[]=@/tmp/phpplheCb" </code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Featured image file. Example: <code>/tmp/phpcNfbCb</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>visibility</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Additional image files. Example: <code>/tmp/phpplheCb</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --form "images[]=@/tmp/phpHBcBBc" \
    --form "images[]=@/tmp/phpDpoOBc" </code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Featured image file. Example: <code>/tmp/phpoOkLBc</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>visibility</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Additional image files. Example: <code>/tmp/phpDpoOBc</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>delete_images[]</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://backend-laravel.dev.jussialanen.com/api/resumes/17" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://backend-laravel.dev.jussialanen.com/api/resumes/17"
);
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the resume. Example: <code>17</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a file. Must be an image. Must not be greater than 5120 kilobytes. Example: <code>/tmp/phpkBMnCc</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>summary</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a file. Must be an image. Must not be greater than 5120 kilobytes. Example: <code>/tmp/phpCNjgac</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>summary</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://backend-laravel.dev.jussialanen.com/api/resumes/17/export/pdf" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://backend-laravel.dev.jussialanen.com/api/resumes/17/export/pdf"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://backend-laravel.dev.jussialanen.com/api/resumes/17/export/html" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://backend-laravel.dev.jussialanen.com/api/resumes/17/export/html"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://backend-laravel.dev.jussialanen.com/api/resumes/17/export/json" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://backend-laravel.dev.jussialanen.com/api/resumes/17/export/json"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://backend-laravel.dev.jussialanen.com/api/resumes/17/preview/pdf?theme=blue&amp;lang=en&amp;template=default&amp;show_skill_levels=1&amp;show_language_levels=1" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://backend-laravel.dev.jussialanen.com/api/resumes/17/preview/pdf"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://backend-laravel.dev.jussialanen.com/api/resumes/17/preview/html?theme=blue&amp;lang=en&amp;template=default&amp;show_skill_levels=1&amp;show_language_levels=1" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://backend-laravel.dev.jussialanen.com/api/resumes/17/preview/html"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://backend-laravel.dev.jussialanen.com/api/resumes/17/preview/signed-url?theme=blue&amp;lang=en&amp;template=default&amp;show_skill_levels=1&amp;show_language_levels=1" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://backend-laravel.dev.jussialanen.com/api/resumes/17/preview/signed-url"
);
...
<div class="bash-example">
    ...
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "file=@/tmp/phpIpijLh" </code></pre></div>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The JSON backup file produced by the export endpoint. Example: <code>/tmp/phpIpijLh</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://backend-laravel.dev.jussialanen.com/api/resumes/17/import/json" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "file=@/tmp/phpKmkMfh" </code></pre></div>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The JSON backup file produced by the export endpoint. Example: <code>/tmp/phpKmkMfh</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "file=@/tmp/phpmLIIkP" </code></pre></div>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Image file to upload. Example: <code>/tmp/phpmLIIkP</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://backend-laravel.dev.jussialanen.com/api/users/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://backend-laravel.dev.jussialanen.com/api/users/17"
);
