...
return [
    ...
    'description' => 'REST API documentation for Jussilog endpoints.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Authenticate with a Sanctum bearer token via the Authorization header, for example: <code>Authorization: Bearer {token}</code>.',
    ],
